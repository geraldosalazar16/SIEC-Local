<div class="right_col" role="main" ng-controller="serv_contrat_tipos_cambios_controller">
  <div class="row">
      ...
      <div class="x_panel">
        ...
        <?php
          if ($modulo_permisos["SERVICIOS"]["catalogos"] == 1) {
              echo '<p>';
              echo '  <button type="button" id="btnNuevo" ng-click="agregar_cambio()" class="btn btn-primary btn-xs btn-imnc" style="float: right;"> ';
              echo '    <i class="fa fa-plus"> </i> Agregar cambio';
              echo '  </button>';
              echo '</p>';
          } 
        ?>
        ...
        <div class="x_content">
          ...
          <table class="table table-striped responsive-utilities">
            ...
            <tbody id="tbodyServicios">
				<tr ng-repeat="x in Tipos_Cambios">
					<td>{{x.NOMBRE}}</td>
					<td>{{x.DESCRIPCION}}</td>
					
					<td>
						<button type="button" ng-click="editar_cambio(x.ID)" class="btn btn-primary btn-xs btn-imnc btnEditar" style="float: right;"> 
                    ...
                    <div class="modal-body"> 
                        <form name="exampleForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="descripcion" id="descripcion" ng-model="formData.descripcion"  ng-class="{ error: exampleForm.descripcion.$error.required && !exampleForm.$pristine}">
