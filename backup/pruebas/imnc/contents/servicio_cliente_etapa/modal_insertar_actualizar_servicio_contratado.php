                    ...
                    <div class="modal-body"> 
                        <form name="exampleForm">
                            <div class='form-group'>
                                ...
                                ng-class="{ error: exampleForm.txtReferencia.$error.required && !exampleForm.$pristine}" ng-disabled="accion=='editar'">
                            </div>
                            <div class="form-group">
							...
							<div class="form-group" ng-show="accion=='editar' && formData.cambio=='S'" ng-repeat="y in Cambios">
                                <label >
									<input type='checkbox' id="formData.chk{{y.ID}}" ng-model="formData.chk[y.ID]" ng-disabled="formData.chk[y.ID]"/><!--ng-init="formData.chk[y.ID]	=	false" -->  
										{{y.NOMBRE}}
								</label>
								<div ng-if="formData.chk[y.ID]">
									...
									<div class='col-md-12' >
										<textarea rows='4' ng-model="formData.descripcion[y.ID]" cols='50' type='text' required='required' class='form-control col-md-7 col-xs-12' " ></textarea> <!--ng-init="formData.descripcion[y.ID] = ''"-->
									</div>	
								</div>
                            </div>
